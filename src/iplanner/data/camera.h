#ifndef IPLANNER_DATA_CAMERA_H_
#define IPLANNER_DATA_CAMERA_H_
...
public:
  ...
  void SetWidthHeight(int width, int height)
  {
    width_ = width;
    height_ = height;
    SetAspect(static_cast<float>(width) / height);
  }
